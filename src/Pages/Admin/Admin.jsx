...
const Admin = () => {
  ...
  const addProductData = async (e) => {
    ...
    try {
      ...
      await axios.post("https://trendzee-server.onrender.com/products", formData, {
        headers: {
    ...
    // const res = await axios.post("http://localhost:5555/products",formData,config)
